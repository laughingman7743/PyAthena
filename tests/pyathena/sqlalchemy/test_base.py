...
class TestSQLAlchemyAthena:
    ...
    def test_reflect_select(self, engine):
        ...
        assert isinstance(one_row_complex.c.col_double.type, pysqlalchemy.types.DOUBLE)
    ...
    def test_get_column_type(self, engine):
        ...
        assert isinstance(dialect._get_column_type("double"), pysqlalchemy.types.DOUBLE)
        assert isinstance(dialect._get_column_type("real"), types.REAL)
